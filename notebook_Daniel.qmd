...
Previous research has shown that depression is often associated with demographic, socioeconomic, social, health, and lifestyle factors. Based on these findings, the following variables are included in the first model:
...
glm_depressed <- glm(
  Depressed_bin ~ Age + Gender + Poverty + MaritalStatus + BMI +
